    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <div class="custom-file">
                <input type="file" class="custom-file-input @error('product_image') is-invalid @enderror" id="product_image" name="product_image">
        ...
        @enderror
        @if($product->picture)
            <img src="{{ asset($product->product_picture) }}" alt="{{ $product->name }}" class="img-thumbnail" width="100" height="100">
        @endif
    </div>
</div>
