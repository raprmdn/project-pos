            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" id="subtotal-preview" name="subtotal-preview" readonly>
                </div>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" id="saved-preview" name="saved-preview" readonly>
                </div>
              </div>
            </div>
            <div class="form-group row">
