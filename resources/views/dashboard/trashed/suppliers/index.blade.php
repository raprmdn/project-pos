...
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item active">Suppliers Trash</li>
@endsection
    ...
    <script>
        $(function() {
            $('#suppliers-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('trash.suppliers.table') }}',
                columns: [
        ...
        $('#suppliers-table').on('click', '.restore-item', function () {
            ...
            $.ajax({
                ...
                Swal.fire({
                    title: 'Supplier " ' + name + ' " has been restored',
                    icon: 'success',
                });
