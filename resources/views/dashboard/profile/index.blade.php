                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8 col-12">
                            ...
                            <p>Password :
                                <button class="btn btn-warning" data-toggle="modal" data-target="#changePassword">Ubah
                                    Password
                                </button>
                            </p>
                        </div>
                ...
                <form action="{{ route('user-profile-information.update') }}" method="post"
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   class="form-control @if ($errors->updateProfileInformation->get('name')) is-invalid @endif"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   class="form-control @if ($errors->updateProfileInformation->get('email')) is-invalid @endif"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <div
                                    class="custom-file @if ($errors->updateProfileInformation->get('photo')) is-invalid @endif">
                            ...
                            <img
                                src="{{ !is_null(auth()->user()->photo) ? asset('storage/' . auth()->user()->photo) : '' }}"
